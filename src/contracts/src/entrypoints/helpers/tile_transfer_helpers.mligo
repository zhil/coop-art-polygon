...
let transfer_bought_token (token_id, token_owner, buyer, operators, ledger, owners, tiles, emitter : token_id * address * address * operator_storage * ledger * owners * tiles * address option ) : ledger * owners * tiles =
    ...
    let ledger_with_transferred_token, owners_with_transferred_token, tiles_with_updated_tile: ledger * owners * tiles = transfer (token_transfer_transaction, transfer_validator, operators, ledger, owners, tiles, emitter) in
    ledger_with_transferred_token, owners_with_transferred_token, tiles_with_updated_tile
