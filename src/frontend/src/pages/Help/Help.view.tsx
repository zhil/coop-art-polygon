...
const Help = ({ contractAddress }: HelpViewProps) => {
  return (
    <HelpStyled>
      <HelpSectionDiv>
        <HelpQuestionDiv>What is the coopart ?</HelpQuestionDiv>
        <HelpArea>
          coopart is a free and open-source boilerplate for developers to fork and modify to create your own NFT
          marketplace on Tezos. You can find the Github repo{' '}
          <a href="https://github.com/coop-art/coop-art" target="_blank" rel="noreferrer">
            <u>here</u>
          </a>{' '}
          ...
          . Notice that coopart.io is just a demo running on the Delphi Testnet for you to play.
        </HelpArea>
        <HelpQuestionDiv>Where is the coopart demo smart contract deployed at?</HelpQuestionDiv>
        <HelpArea>{`${contractAddress}`}</HelpArea>
        <HelpQuestionDiv>How to add a token into the Temple wallet?</HelpQuestionDiv>
        <HelpArea>
...
6) Temple will try to load the token metadata from https://coopart.io/metadata/contract_metadata.json\n
