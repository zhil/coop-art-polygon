// prettier-ignore
import { useAccountPkh, useOnBlock } from "dapp/dapp";
...
export const Admin = ({ setMintTransactionPendingCallback, mintTransactionPending }: AdminProp) => {
  ...
  const mint = React.useCallback(async () => {
    ...
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage3.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 2, 0))
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage4.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 0, 1))
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage5.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 3, 1))
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage6.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 2, 1))
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage7.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 0, 2))
    //   .withContractCall((ctr as any).methods.mint('rage', '2021-08-25t10:10:10Z', 'https://coopart.io/examples/rage8.png', ADMIN, ADMIN, 100, Math.floor(Math.random() * 1000000), 100, 1, 2))
