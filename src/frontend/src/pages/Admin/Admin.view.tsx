...
// prettier-ignore
import { AdminLandBottom, AdminLandCoordinateInput, AdminLandFirstRow, AdminLandLocation, AdminLandNameInput, AdminLandStyled, AdminStyled, DescriptionTextArea } from "./Admin.style";
  ...
  return (
    <AdminLandStyled>
      ...
      <AdminLandBottom>
        ...
        <AdminLandNameInput value={landName} onChange={(e) => setName(e.target.value)} placeholder="Enter land name" />
        <DescriptionTextArea
